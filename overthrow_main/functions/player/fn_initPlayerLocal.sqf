...
player createDiaryRecord ["page1", ["Airdrops","Airdrops will periodically be sent over to the island as a gesture of goodwill from IDAP. Normally these should be gathered and distributed by the UN forces present but they’re both too corrupt and inept to carry this out. This leaves you to fill their role and hunt down the drops and make good use of its supplies for the resistance thusly for the people.<br></br><br></brbeforeEveryone on the server will receive a radio notification when an airdrop arrives along with a circular purple marker appearing on the map showing the general location of where the drop zone is.<br></br> <img image='\overthrow_main\flags\example1.paa'width='100' height='100' /><br></br><br></br>P.S: The airdrop is sent via an actual ingame helicopter and thusly, depending on where it spawns may take upwards to 10-15 minutes to actually arrive and drop its cargo. <br></br>P.P.S: The cargo drop will despawn after a while so make sure to get it before it does."]];
player createDiaryRecord ["page1", ["Capturing a Town","Inorder to capture a town you must drop its stability to 0, this can be done by completing a number of unsavoury activities such as selling drugs to civilians,killing police and NATO soldiers, and completing certain jobs. (Keep in mind some activities may raise the stability of a town, mainly the bulk selling of needed goods.).<br></br><br></br>Once the stability hits 0, the town will enter “anarchy” and NATO will react by either abandoning it, leaving you free to return order as you please, or launch an attack to claim it back and restore order. It's important to note NATO will only choose to abandon towns with tiny populations. Another key detail is that the size of NATO’s assault is based off the size of the town, and its distance from NATO outposts, so for your first takeover, its wise to choose a village somewhere remote.<br></br><br></br>Assuming NATO didn't choose to abandon the town, you will receive a 10 minute notice prior to the sidge where NATO wont send any further troops to the town and will instead be moving units into position to assault. Because of this, the short break offers a key opportunity to place HMG nests, mine roads (NATO tends to attack from the direction of the closest bases), and lay other guerilla traps that will greatly increase your chances against the overwhelming and superior troops that NATO has to offer.<br></br><br></br>Once the battle starts the timer will transform into a percentage marker, showing the resistance which side of the conflict is winning. If it's green, you're winning, if it's blue then NATO is winning. Inorder to gain score you must have more troops within a certain range of the town then NATO. If the marker hits 100% for NATO or the battle ends in a stalemate (which occurred after a large amount of time passes) you’ll lose the fight and the town's stability will reset and the occupying military force will remain for some time. Obviously the opposite is true for you and if the marker hits 100% on your side, the town will remain in anarchy and NATO will leave it be for a large period of time (later in the game they will have the option to attempt to recapture it.) .<br></br><br></br> Once the town is anarchy, you're granted the chance to move in and gain favour to get overship over the locale. Inorder to do this you must raise its stability over 50% then the people will flip to your side and the town will be marked with a green circle around it. There are two main ways to do this, either destroy gangs that pop up around the place or build a police station and have the officers slowly restore law. Once you finally gain the town you can look forward to a sizable amount of tax income and influence every 6 months from the residence of the place."]];
player createDiaryRecord ["page1", ["Starting Out","Given you haven't completed the tutorial, you should have access to nothing more than a backpack and a few miscellaneous items. It's advisable to wait for a band of looters to wander near the town and get gunned down. Once you spot their freshly created corpses, try to sneakily loot them (keep in mind looting is a no-go for both UN and NATO forces and you will be shot on sight if you're caught attempting it.) Now that you have access to a weapon,try killing the remaining police, loot them, and quickly move to a different town to operate because NATO will react to your hostiltes and send a QRF to mow you down mercilessly.</br><t align='center'> <img image='\overthrow_main\flags\example2.paa'width='300' height='250' /></t></br>Alternatively, if you prefer a less violent way to make some early game cash you can try looking around the nearby houses for electronics laying about (NATO won’t care if you're seen taking these as the owners of the houses have long since fled the island.) Along with this you can ask the shopkeepers for work who (unless you have negative reputation with the town) will happily supply you with a simple delivery quest.<br></br><br></br>Lastly, you can always try talking to the various factions who will happily offer you work which is varied and well paying but may require clashing with Nato forces to complete. If you have joined a game in-progress there's a chance a gang (indicated by a red tent icon) may have spawned around a low stability town (a town with under 50% stability) and there the leader will offer you a job and who knows, maybe if you complete enough of them, they start to side with the rebellion."]];
player createDiaryRecord ["page1", ["Intro","Thank you for trying my overthrow modification!<br></br><br></br>The goal of this mod is to conquer the island through staging a violent guerilla warfare campaign against the tyrannical Nato forces and liberate the people from the Nato Forces<br></br><br></br>This mod focuses on the build up from a small anarchic group and growing into a full fledge army, at the start you will have nothing more than a few dollars to your name and a house, but by completing jobs, looting bodies, and eventually trading and buying business you can gain the funds to finance a grand fighting force!"]];
