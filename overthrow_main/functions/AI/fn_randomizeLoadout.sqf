...
if(_hasPrimary) then {
    ...
    private _wpn = _base call {
		if((_this == "srifle_LRR_camo_F") || (_this == "rhs_weap_M107") || (_this == "srifle_LRR_tna_F")) exitWith {selectRandom _sniperRifles};
		if(_this == "LMG_Zafir_F") exitWith {selectRandom _machineGuns};
