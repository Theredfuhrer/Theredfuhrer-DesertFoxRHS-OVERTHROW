...
while {!_break && _tries < 100} do{
	...
	if (_isEmpty) then {
		...
		["RHS_M119_WD",[11.3774,13.53,-0.0827584],179.342,1,0,[1.4638,-0.0243913],"","",true,false], 
		...
		["RHS_M119_WD",[-16.0465,13.53,-0.0820904],179.342,1,0,[1.46437,-0.0243367],"","",true,false],
