...
OT_NATOBluprints = ["B_T_Truck_01_fuel_F","B_T_Truck_01_box_F","B_T_Truck_01_ammo_F","B_T_Truck_01_covered_F","B_T_Truck_01_transport_F","B_T_LSV_01_unarmed_F","B_T_LSV_01_AT_F","B_T_LSV_01_armed_F","B_T_Quadbike_01_F","B_T_MRAP_01_F","B_T_MRAP_01_gmg_F","B_T_MRAP_01_hmg_F","B_Heli_Light_01_dynamicLoadout_F","B_Heli_Transport_03_unarmed_F","B_T_APC_Wheeled_01_cannon_F","B_T_Boat_Armed_01_minigun_F","B_CTRG_LSV_01_light_F","rhsusf_m1025_w_m2","rhsusf_m1025_w_Mk19","rhsusf_m1025_w","rhsusf_m1045_w","RHS_CH_47F","rhsusf_M1117_w","rhsusf_M1220_usarmy_w","rhsusf_M1220_M2_usarmy_w","rhsusf_M1078A1P2_w_fmtv_usarmy","rhsusf_M977A4_AMMO_BKIT_usarmy_w","rhsusf_M977A4_REPAIR_usarmy_w","rhsusf_M978A4_usarmy_w","rhsusf_m998_w_s_2dr_fulltop","RHS_UH1Y_UNARMED_w","RHS_UH1Y_w"]; //List of blueprints player can get from laptop
...
if (isClass(configfile >> "CfgPatches" >> "A3_Weapons_F_Aegis_LongRangeRifles_DMR_01")) then { //Aegis
	...
	_append = ["SMG_04_khk_F","sgun_M4_F"];
