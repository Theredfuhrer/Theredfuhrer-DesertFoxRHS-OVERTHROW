class CfgWeapons {
	...
	class OT_NVC: OT_ItemCore {
        ...
        descriptionShort = "Various chemcials that are utterly useless when it comes to being turned into weapons, but could be used in the making of other, more valuable, materials.";
        descriptionUse = "";
        class ItemInfo: InventoryItem_Base_F {
            mass = 15;
        };
	...
	class OT_CE: OT_ItemCore {
        ...
        descriptionShort = "Generic knockoffs of name brand electronics, can be sold for a large sum of cash.";
        descriptionUse = "";
        class ItemInfo: InventoryItem_Base_F {
            mass = 30;
        };
	...
	class optic_KHS_old : ItemCore {
		ot_craftable = 1;
		ot_craftQuantity = 1;
		ot_craftRecipe = "[[""Binocular"",1],[""ToolKit"",1],[""SmokeShell"",4]]";
	};
	...
	//Craftable Rockets
		...
		ot_craftable = 1;
		ot_craftQuantity = 2;
		ot_craftRecipe = "[[""HandGrenade"",3],[""HandGrenade"",3],[""SmokeShell"",2],[""Uniform_Base"",1]]";
	};
