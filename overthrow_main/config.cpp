...
class CfgPatches
{
	...
	{
		author="Edited by deadorbit;edited again TheDesertFox";
		name=COMPONENT_NAME;
        ...
        VERSION_CONFIG;
		units[] = {"OT_GanjaItem","OT_BlowItem","OT_C_Truck_recovery"};
...
class CfgMissions
{
	...
	class MPMissions
	{
		class DFOverthrowTanoa
		{
			directory="overthrow_main\campaign\missions\DFOverthrowTanoa.Tanoa";
		};
		class DFOverthrowAltis
		{
			directory="overthrow_main\campaign\missions\DFOverthrowAltis.Altis";
		};
		class DFOverthrowMalden
		{
			directory="overthrow_main\campaign\missions\DFOverthrowMalden.Malden";
		};
		class DFOverthrowEnoch
		{
			directory="overthrow_main\campaign\missions\DFOverthrowEnoch.Enoch";
		};
	};
};
