...
private _description = format["A traitor of %1 has fled here and is hiding in %2 under NATO protection. %1 will pay handsomely and be very grateful if you could just.. make them disappear. <br/><br/>Reward: +20 (%1), $1500",_factionName,_destinationName];
            ...
            [
                {
					...
					[1500] call OT_fnc_money;

                    private _factionName = server getvariable format["factionname%1",_faction];
                    format ["Incoming message from %1: Traitor neutralized. Sending our regards and $3500. (+20 %1)",_factionName] remoteExec ["OT_fnc_notifyMinor",0,false];
