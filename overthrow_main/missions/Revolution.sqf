...
private _description = format["It seems a group of so called 'patriots' have risen up and started a plot to overthrow the resistance and establish democracy in this town. I've already found out where there base of operatoins is, I'd advise elminiating their higher ups and the rest should sort itself out. <br/><br/>Reward: $750, -20 stabilty (%1)",_Currenttown];
            ...
            [
                {
					...
					[_Currenttown,-20] call OT_fnc_stability;

                    format ["That'll teach them a lesson, sending you the $750 and feel free to take whatever you want from their camp. (-20 stabilty %1)",_Currenttown] remoteExec ["OT_fnc_notifyMinor",0,false];
                },
                [_Currenttown],
                2
