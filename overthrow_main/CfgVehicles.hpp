...
class CfgVehicles {
	...
	class OT_C_Truck_recovery : C_Truck_02_box_F {
		scope = 2;
		author = "ARMAzac";
	...
	class Com_Police_N: B_GEN_Soldier_F { //You may use anything you want, just make sure it's unique
        ...
        respawnLinkedItems[] = {};
		Weapons[] = {"SMG_02_F","rhsusf_weap_m1911a1","Throw","Put"}; // only add rifle & / pistol classname, leave throw and put they are used for explosives and grenades 
        respawnWeapons[] = {}; 
		items[] = {"FirstAidKit"};
        Magazines[] = {"30Rnd_9x21_Mag_SMG_02","30Rnd_9x21_Mag_SMG_02","30Rnd_9x21_Mag_SMG_02","30Rnd_9x21_Mag_SMG_02","30Rnd_9x21_Mag_SMG_02","30Rnd_9x21_Mag_SMG_02","30Rnd_9x21_Mag_SMG_02","rhsusf_mag_7x45acp_MHP","rhsusf_mag_7x45acp_MHP","ACE_m84"};  //Ammo goes here
        respawnMagazines[] = {};
    };
	...
	class Com_Police_N2: B_GEN_Soldier_F { //You may use anything you want, just make sure it's unique
        ...
        linkedItems[] = {"V_TacVest_blk_POLICE","rhsgref_ssh68_un","G_Bandanna_aviator", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"}; //Helmets, vests and small items go here
        respawnLinkedItems[] = {};
		Weapons[] = {"rhs_weap_savz61","rhsusf_weap_m1911a1","Throw","Put"}; // only add rifle & / pistol classname, leave throw and put they are used for explosives and grenades 
        respawnWeapons[] = {};
		items[] = {"FirstAidKit"};		
        Magazines[] = {"rhsgref_20rnd_765x17_vz61","rhsgref_20rnd_765x17_vz61","rhsgref_20rnd_765x17_vz61","rhsgref_20rnd_765x17_vz61","rhsgref_20rnd_765x17_vz61","rhsgref_20rnd_765x17_vz61","rhsusf_mag_7x45acp_MHP","rhsusf_mag_7x45acp_MHP","ACE_m84"};  //Ammo goes here
        respawnMagazines[] = {};
    };
